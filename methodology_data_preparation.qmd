...
![Fig 1.1, Natural Reserve Buffer](nature_reserves.jpg)
...
![Fig 1.2, NASA LST temperature data acquisition](temperature_data.jpg)
...
![Fig 1.3, NASA LST temperature data results graph](temperature_results.jpg)
...
![Fig 1.4, POWER Project API call result JSON result](isolated_solar_data.jpg)
...
![Fig 1.5, NASA LST temperature data results collation](masterfile_data.jpg)
